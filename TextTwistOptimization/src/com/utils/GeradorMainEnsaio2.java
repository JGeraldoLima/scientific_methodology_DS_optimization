...
public class GeradorMainEnsaio2 {
    ...
    public static void generateSample() throws FileNotFoundException {
        ...
        PrintWriter writer = new PrintWriter("content/consults_ensaio2.txt");
        System.out.println("Running");
        System.out.println("Starting....make consults");
        generateSample(writer, 20000);
        System.out.println("consults done");
        writer = new PrintWriter("content/sample_ensaio2.txt");
        System.out.println("Starting....make consults");
        generateSample(writer, 50000000);
