...
public class GeradorMainEnsaio4 {
    ...
    public static void generateSample() throws FileNotFoundException {
        ...
        PrintWriter writer = new PrintWriter("content/consults_ensaio4.txt");
        System.out.println("Running");
        System.out.println("Starting....make consults");
        generateSample(writer, 500000);
        System.out.println("consults done");
        writer = new PrintWriter("content/sample_ensaio4.txt");
        System.out.println("Starting....make consults");
        generateSample(writer, 25000000);
